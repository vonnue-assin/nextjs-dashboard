...
export async function fetchCardData() {
  try {
    ...
    ]); //starts executing all data fetches at the same time,which is faster than waiting for each request to complete in a waterfall.
...
// The data requests are creating an unintensional waterfall.
